...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  ...
  if (bookInstances.length > 0) {
    // Book has associated BookInstances, so it can't be deleted.
    ...
    // Book has no associated BookInstances, so it can be deleted.
    res.render("book_delete", {
      title: "Delete Book",
      book: book,
    });
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (bookInstances.length > 0) {
    ...
    // Book has no associated BookInstances, delete the book.
